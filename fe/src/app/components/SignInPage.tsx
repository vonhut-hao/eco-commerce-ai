...
const trustIndicators = [
  { label: "ECO-CERTIFIED PRODUCTS",    viewBox: "0 0 22 21", path: "p13774060", w: 22, h: 21 },
  { label: "TRANSPARENT SUPPLY CHAIN",  viewBox: "0 0 22 15", path: "p3e801e80", w: 22, h: 15 },
  { label: "CARBON-TRACKED SHIPPING",   viewBox: "0 0 22 16", path: "p146eb80",  w: 22, h: 16 },
] as const;

export function SignInPage({ onNavigate }: { onNavigate: (page: string) => void }) {
    ...
    <div className="min-h-screen flex bg-gradient-to-b from-[#f3f7ee] via-[#fafaf5] to-[#edf3e7]">
      ...
      <div className="hidden md:flex flex-col justify-between p-16 bg-gradient-to-br from-[#e7f2e1] via-[#eef6e9] to-[#d7edcd] relative overflow-hidden shrink-0" style={{ width: "55%", maxWidth: 704 }}>
        ...
        <div className="flex flex-col gap-6 max-w-[512px]">
          <h1 className="text-[#1a1c19] font-['Nimbus_Sans:Bold',sans-serif] text-[48px] tracking-[-0.96px] leading-[60px]">
            ...
            {trustIndicators.map((item) => (
              <div key={item.label} className="flex items-center gap-2">
                <svg width={item.w} height={item.h} viewBox={item.viewBox} fill="none" className="shrink-0">
                  <path d={(svgPaths as Record<string, string>)[item.path]} fill="#42493E" />
                </svg>
      ...
      <div className="flex-1 bg-white flex flex-col md:border-l border-[rgba(194,201,187,0.3)]">
        ...
        <div className="w-full max-w-[448px] flex flex-col gap-6 pt-[50px] pb-8 md:py-8">
          ...
          <div className="flex flex-col gap-2 text-center">
            <h2 className="text-[#25521f] font-['Nimbus_Sans:Bold',sans-serif] text-[32px] leading-[40px]">Sign in</h2>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[#1a1c19] font-['Nimbus_Sans:Bold',sans-serif] text-[14px] tracking-[1.3px] uppercase">
                Username or email
              </label>
          ...
          <p className="text-center text-[#42493e] text-[14px] leading-[21px]">
            ...
            <button onClick={() => onNavigate("signup")} className="text-[#25521f] underline hover:text-[#1e4219] transition-colors">
              Create Account
            </button>
          </p>
        </div>
